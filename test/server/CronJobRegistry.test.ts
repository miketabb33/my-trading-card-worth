...
describe('Cron Job Registry', () => {
  ...
  beforeEach(() => {
    ...
    cronJobRegistry = new CronJobRegistry(
      pricesUpdater_FAKE,
      expansionUpdater_FAKE
    )
  })
  ...
  it('should start with production settings', () => {
    ...
    expect(pricesUpdater_FAKE.START).toHaveBeenCalledWith(
      { days: 4 },
      14_400_000
    )
    expect(expansionUpdater_FAKE.START).toHaveBeenCalledWith(
      { days: 2 },
      14_400_000
    )
  })
